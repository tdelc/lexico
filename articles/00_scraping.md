...
permettent respectivement de récupérer la liste des vidéos et leurs
statistiques.
...
s’appuie sur `yt-dlp` pour récupérer les sous-titres automatiques en
français.
...
combine toutes les étapes (métadonnées + sous-titres + sauvegarde CSV).
...
playlist : df_info, df_stat, df_text. Dans le même répertoire se trouve
également un répertoire avec tous les fichiers vtt de sous-titres.
