...
df_text <- read.csv("~/Github/lexico/inst/extdata/df_text_bfm.csv")
...
export_to_iramuteq(
  ...
  text_col = "text",
  output_file = "~/Github/lexico/inst/extdata/corpus_bfm.txt"
)
```
...
```{r import}
path_corpus <- "~/Github/lexico/inst/extdata/corpus_bfm/corpus_bfm_alceste_1/"
