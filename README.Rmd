...
-   [Scraper des playlists YouTube](https://tdelc.github.io/lexico/articles/scraping.html) pour apprendre à extraire les vidéos, leurs sous-titres et mettre en format base de données les informations.

-   [Préparer les données textuelles](https://tdelc.github.io/lexico/articles/prepa-data.html) où j'explique comment j'ai nettoyé le corpus.

-   [Préparer et exploiter des corpus avec IRaMuTeQ](https://tdelc.github.io/lexico/articles/iramuteq.html) pour comprendre comment exploiter ce corpus avec IRaMuTeQ.

-   [Analyser les textes avec Quanteda](https://tdelc.github.io/lexico/articles/quanteda.html) pour l'analyse du corpus avec le package R Quanteda
